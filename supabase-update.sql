...
-- ----------------------------------------------------------------
-- PARTE 3: Tabla de configuración del torneo
-- ----------------------------------------------------------------
...
-- ================================================================
-- PARTE 4: PARTIDOS FASE DE GRUPOS (IDs 1000001–1000072)
-- Banderas: https://flagicons.lipis.dev/flags/4x3/{iso2}.svg
-- Grupos, jornadas y horarios (UTC)
-- ================================================================
...
-- ================================================================
-- PARTE 5: ROUND OF 32 (IDs 1000073–1000088)
-- Bracket oficial ESPN/FIFA (Cruces pre-determinados)
-- Los equipos se llenarán automáticamente al terminar grupos
-- ================================================================
...
-- ================================================================
-- PARTE 6: ROUND OF 16 (IDs 1000089–1000096)
-- ================================================================
INSERT INTO public.fixtures (id,league_id,season,round,phase,status,kickoff,bracket_position,home_placeholder,away_placeholder)
VALUES
...
-- ================================================================
-- PARTE 7: CUARTOS DE FINAL (IDs 1000097–1000100)
-- ================================================================
INSERT INTO public.fixtures (id,league_id,season,round,phase,status,kickoff,bracket_position,home_placeholder,away_placeholder)
VALUES
...
-- ================================================================
-- PARTE 8: SEMIFINALES (IDs 1000101–1000102)
-- ================================================================
INSERT INTO public.fixtures (id,league_id,season,round,phase,status,kickoff,bracket_position,home_placeholder,away_placeholder)
VALUES
...
-- ================================================================
-- PARTE 10: Poblar tabla groups con los 48 equipos
-- ================================================================
...
-- ================================================================
-- FIN
-- Después de ejecutar: ve a /admin → los 104 partidos aparecen
-- ================================================================
